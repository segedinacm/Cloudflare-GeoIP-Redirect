...
class AdminPageFramework_View__PageRenderer extends AdminPageFramework_FrameworkUtility {
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'wicfr-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
