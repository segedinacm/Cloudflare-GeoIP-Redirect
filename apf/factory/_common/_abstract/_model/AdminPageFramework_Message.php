...
class AdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'wicfr';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'wicfr') {
    ...
    public static function instantiate($sTextDomain = 'wicfr') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'wicfr') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'wicfr');
        __('The options have been cleared.', 'wicfr');
        __('Export', 'wicfr');
        __('Export Options', 'wicfr');
        __('Import', 'wicfr');
        __('Import Options', 'wicfr');
        __('Submit', 'wicfr');
        __('An error occurred while uploading the import file.', 'wicfr');
        __('The uploaded file type is not supported: %1$s', 'wicfr');
        __('Could not load the importing data.', 'wicfr');
        __('The uploaded file has been imported.', 'wicfr');
        __('No data could be imported.', 'wicfr');
        __('Upload Image', 'wicfr');
        __('Use This Image', 'wicfr');
        __('Insert from URL', 'wicfr');
        __('Are you sure you want to reset the options?', 'wicfr');
        __('Please confirm your action.', 'wicfr');
        __('The specified options have been deleted.', 'wicfr');
        __('A problem occurred while processing the form data. Please try again.', 'wicfr');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'wicfr');
        __('Is it okay to send the email?', 'wicfr');
        __('The email has been sent.', 'wicfr');
        __('The email has been scheduled.', 'wicfr');
        __('There was a problem sending the email', 'wicfr');
        __('Title', 'wicfr');
        __('Author', 'wicfr');
        __('Categories', 'wicfr');
        __('Tags', 'wicfr');
        ...
        __('Date', 'wicfr');
        __('Show All', 'wicfr');
        __('Show All Authors', 'wicfr');
        __('Thank you for creating with', 'wicfr');
        __('and', 'wicfr');
        __('Settings', 'wicfr');
        __('Manage', 'wicfr');
        __('Select Image', 'wicfr');
        __('Upload File', 'wicfr');
        __('Use This File', 'wicfr');
        __('Select File', 'wicfr');
        __('Remove Value', 'wicfr');
        __('Select All', 'wicfr');
        __('Select None', 'wicfr');
        __('No term found.', 'wicfr');
        __('Select', 'wicfr');
        __('Insert', 'wicfr');
        __('Use This', 'wicfr');
        __('Return to Library', 'wicfr');
        __('%1$s queries in %2$s seconds.', 'wicfr');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'wicfr');
        __('Peak memory usage %1$s MB.', 'wicfr');
        __('Initial memory usage  %1$s MB.', 'wicfr');
        __('The allowed maximum number of fields is {0}.', 'wicfr');
        __('The allowed minimum number of fields is {0}.', 'wicfr');
        __('Add', 'wicfr');
        __('Remove', 'wicfr');
        __('The allowed maximum number of sections is {0}', 'wicfr');
        __('The allowed minimum number of sections is {0}', 'wicfr');
        __('Add Section', 'wicfr');
        __('Remove Section', 'wicfr');
        __('Toggle All', 'wicfr');
        __('Toggle all collapsible sections', 'wicfr');
        __('Reset', 'wicfr');
        __('Yes', 'wicfr');
        __('No', 'wicfr');
        __('On', 'wicfr');
        ...
        __('Disabled', 'wicfr');
        __('Supported', 'wicfr');
        __('Not Supported', 'wicfr');
        __('Functional', 'wicfr');
        __('Not Functional', 'wicfr');
        __('Too Long', 'wicfr');
        __('Acceptable', 'wicfr');
        __('No log found.', 'wicfr');
        __('The method is called too early: %1$s', 'wicfr');
        __('Debug Info', 'wicfr');
        __('Click here to expand to view the contents.', 'wicfr');
        __('Click here to collapse the contents.', 'wicfr');
        __('Loading...', 'wicfr');
        __('Please enable JavaScript for better user experience.', 'wicfr');
        __('Debug', 'wicfr');
        __('Field Arguments', 'wicfr');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'wicfr');
        __('Section Arguments', 'wicfr');
        __('The ability to repeat sections is disabled.', 'wicfr');
        __('The ability to repeat fields is disabled.', 'wicfr');
        __('Warning.', 'wicfr');
    }
    }
