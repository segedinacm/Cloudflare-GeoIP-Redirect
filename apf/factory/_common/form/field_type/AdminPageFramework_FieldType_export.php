...
class AdminPageFramework_FieldType_submit extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".wicfr-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'wicfr-input-label-container' . ' wicfr-input-button-container' . ' wicfr-input-container',);
    }
