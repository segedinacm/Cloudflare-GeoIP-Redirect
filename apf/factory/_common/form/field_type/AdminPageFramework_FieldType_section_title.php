...
class AdminPageFramework_FieldType_section_title extends AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".wicfr-section-tab .wicfr-field-section_title {padding: 0.5em;} .wicfr-section-tab .wicfr-field-section_title .wicfr-input-label-string { vertical-align: middle; margin-left: 0.2em;}.wicfr-section-tab .wicfr-fields {display: inline-block;} .wicfr-field.wicfr-field-section_title {float: none;} .wicfr-field.wicfr-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
