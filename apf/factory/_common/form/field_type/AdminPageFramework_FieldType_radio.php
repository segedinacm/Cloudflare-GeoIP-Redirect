...
class AdminPageFramework_FieldType_radio extends AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".wicfr-field input[type='radio'] {margin-right: 0.5em;} .wicfr-field-radio .wicfr-input-label-container {padding-right: 1em;} .wicfr-field-radio .wicfr-input-container {display: inline;} .wicfr-field-radio .wicfr-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.wicfr-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
