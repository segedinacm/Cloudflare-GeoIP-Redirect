...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.wicfr-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.wicfr-checkbox-label {margin-top: 0.1em;}.wicfr-field input[type='checkbox' ] {margin-right: 0.5em;} .wicfr-field-checkbox .wicfr-input-label-container {padding-right: 1em;}.wicfr-field-checkbox .wicfr-input-label-string{display: inline; }";
    }
    ...
    class AdminPageFramework_FieldType_posttype extends AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".wicfr-field input[type='checkbox'] {margin-right: 0.5em;} .wicfr-field-posttype .wicfr-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
