...
class AdminPageFramework_FieldType_import extends AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".wicfr-field-import input {margin-right: 0.5em;}.wicfr-field-import label,.form-table td fieldset.wicfr-fieldset .wicfr-field-import label { display: inline; }";
    }
