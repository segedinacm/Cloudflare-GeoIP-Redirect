...
(function($) {
    $.fn.enableAdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'wicfr-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.wicfr-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.wicfr-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .wicfr-collapsible-toggle-all-button-container )', 
                handle: _bCollapsible
                    ? '.wicfr-section-caption'
                    : false,
                ...
                stop: function(e,ui) {
                    ...
                    jQuery( this ).trigger( 
                        'wicfr_stopped_sorting_sections', 
                ...
                // cancel: '.wicfr-section-description, .wicfr-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .wicfr-section-title:not(.wicfr-collapsible-sections-title,.wicfr-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .wicfr-section-title:not(.wicfr-collapsible-sections-title,.wicfr-collapsible-section-title)' ).not( ':first' ).hide();
...
JAVASCRIPTS;
            return "<script type='text/javascript' class='wicfr-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
        }
    }
